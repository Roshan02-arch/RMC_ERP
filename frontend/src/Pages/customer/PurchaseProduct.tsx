   ...
   <div className="min-h-screen bg-gray-100">
     ...
     <div className="w-full max-w-3xl bg-white rounded-2xl shadow-xl p-8">
       ...
       <div className="mt-6 text-lg font-semibold text-gray-800">
         Total Price: <span className="text-indigo-600">₹{calculateTotal()}</span>
       </div>
       ...
       <div className="space-y-4">
         {orders.map((order) => (
           ...
           >
             ...
             <p className="text-sm"><strong>Grade:</strong> {order.grade}</p>
             <p className="text-sm"><strong>Quantity:</strong> {order.quantity} m³</p>
