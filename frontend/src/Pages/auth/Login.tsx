    ...
    <div className="relative flex min-h-screen flex-col overflow-x-hidden bg-[#050508] font-sans text-white">
      ...
      <div className="pointer-events-none absolute inset-0 z-[2] overflow-hidden">
        {floatingSymbols.map((item, index) => (
          <span
            key={`${item.icon}-${index}`}
            className="absolute text-2xl text-indigo-300/20 animate-pulse"
            style={{
              top: item.top,
              bottom: item.bottom,
              left: item.left,
            ...
            <div>
              ...
              <div className="relative">
                ...
                <span
                  ...
                  className="absolute right-4 top-1/2 -translate-y-1/2 cursor-pointer text-white/60 transition hover:text-indigo-300"
                >
