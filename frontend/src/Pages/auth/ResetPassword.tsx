    ...
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-indigo-100 via-purple-50 to-blue-100 px-4 py-12">
      <div className="w-full max-w-[440px]">
        ...
        <div className="flex items-center justify-center gap-2 mb-6">
          <div className={`h-2 w-16 rounded-full transition-all ${!otpVerified ? "bg-indigo-600" : "bg-indigo-300"}`} />
          <div className={`h-2 w-16 rounded-full transition-all ${otpVerified ? "bg-indigo-600" : "bg-gray-200"}`} />
        </div>
